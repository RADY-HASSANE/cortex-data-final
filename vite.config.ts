...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      plugins: [react()],
      define: {
        'process.env.API_KEY': JSON.stringify(env.OPENROUTER_API_KEY || env.VITE_OPENROUTER_API_KEY || ''),
        ...
        'process.env.N8N_API_KEY': JSON.stringify(env.N8N_API_KEY || env.VITE_N8N_API_KEY || '')
      },
      resolve: {
        alias: {
